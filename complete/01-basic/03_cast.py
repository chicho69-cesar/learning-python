...
# Convertir un entero a cadena para concatenar lo con otra cadena
...
print(int(input("Escribe un número: ")))  # Convierte la entrada del usuario a entero
...
try:
    print(int("Hola mundo"))  # Intento de convertir una cadena no numérica a entero
except ValueError as e:
    print(f"Error: {e}")
finally:
    print("Conversión fallida, no se puede convertir 'Hola mundo' a entero.")
