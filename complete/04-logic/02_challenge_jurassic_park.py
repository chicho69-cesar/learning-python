...
def count_carnivore_dinosaur_eggs(egg_list) -> int:
    """
    Esta función recibe una lista de números enteros que representan la 
    cantidad de huevos que han puesto diferentes dinosaurios en el parque 
    jurásico y los de número par son de carnívoros. Devuelve un número 
    con la suma de todos los huevos de carnívoros.
    """
    total_carnivore_eggs = 0

    for eggs_item in egg_list:
        if eggs_item % 2 == 0:
            total_carnivore_eggs += eggs_item
...
eggs = [3, 4, 7, 5, 8]
print(count_carnivore_dinosaur_eggs(eggs)) # 12
